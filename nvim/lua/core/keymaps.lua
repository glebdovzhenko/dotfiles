...
vim.keymap.set('v', 'tn', ":tabNext<CR>", { desc = 'Next tab' })
vim.keymap.set('v', 'tp', ":tabprev<CR>", { desc = 'Previous tab' })
vim.keymap.set('v', 'tN', ":tabnew<CR>", { desc = 'New tab' })
vim.keymap.set('v', 'tc', ":tabclose<CR>", { desc = 'Close tab' })
